...
def build() -> None:
    ...
    PyInstaller.__main__.run([
        ...
        '--hidden-import', 'twitchirc_drgreengiant',
        ...
        '--add-data', f'{DIRPATH / "src" / "simonsays_drgreengiant" / "assets" / "Green_tato_640.png"}{SEPARATOR}assets',
        '-i', f'{DIRPATH / "src" / "simonsays_drgreengiant" / "assets" / "Green_tato_640.png"}',
        # '-n %CurrDirName%',
    ])
